...
public class TemporadaResource {
    ...
    @Timed
    public ResponseEntity<Temporada> create(@Valid @RequestBody Temporada temporada) throws URISyntaxException {
    ...
    @RequestMapping(value = "/temporadas",
        ...
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<Temporada> update(@Valid @RequestBody Temporada temporada) throws URISyntaxException {
