    ...
    .config(function ($stateProvider) {
        $stateProvider
            .state('partido', {
                ...
                data: {
                    roles: ['ROLE_USER'],
                    pageTitle: 'ligabApp.partido.home.title'
                },
                views: {
                    'content@': {
            ...
            .state('partido.detail', {
                ...
                data: {
                    roles: ['ROLE_USER'],
                    pageTitle: 'ligabApp.partido.detail.title'
                },
                views: {
                    'content@': {
            ...
            .state('partido.new', {
                ...
                onEnter: ['$stateParams', '$state', '$modal', function($stateParams, $state, $modal) {
                    $modal.open({
                        ...
                        resolve: {
                            entity: function () {
                                return {localPuntos: null, puntosVisitante: null, inicioPartido: null, finalPartido: null, id: null};
                            }
                        }
