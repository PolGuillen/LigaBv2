    ...
    .config(function ($stateProvider) {
        $stateProvider
            .state('estadisticas', {
                ...
                data: {
                    roles: ['ROLE_USER'],
                    pageTitle: 'ligabApp.estadisticas.home.title'
                },
                views: {
                    'content@': {
            ...
            .state('estadisticas.detail', {
                ...
                data: {
                    roles: ['ROLE_USER'],
                    pageTitle: 'ligabApp.estadisticas.detail.title'
                },
                views: {
                    'content@': {
            ...
            .state('estadisticas.new', {
                ...
                onEnter: ['$stateParams', '$state', '$modal', function($stateParams, $state, $modal) {
                    $modal.open({
                        ...
                        resolve: {
                            entity: function () {
                                return {canastas: null, asistencias: null, faltas: null, rebotes: null, id: null};
                            }
                        }
