...
class TeamGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Team entity")
        ...
        .repeat(2) {
            ...
            .post("/api/teams")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "nombre":"SAMPLE_TEXT", "localidad":"SAMPLE_TEXT", "fecha_creacion":"2020-01-01T00:00:00.000Z"}""")).asJSON
            .check(status.is(201))
            .check(headerRegex("Location", "(.*)").saveAs("new_team_url")))
            .pause(10)
            .repeat(5) {
