...
import com.vasilmarkov.appjhipster.repository.EntrenadorRepository;
...
public class EntrenadorResourceTest {
    ...
    private static final LocalDate DEFAULT_EDAD = new LocalDate(0L);
    private static final LocalDate UPDATED_EDAD = new LocalDate();
    ...
    public void initTest() {
        ...
        entrenador.setEdad(DEFAULT_EDAD);
    }
    ...
    public void createEntrenador() throws Exception {
        ...
        assertThat(testEntrenador.getEdad()).isEqualTo(DEFAULT_EDAD);
    }
    ...
    public void updateEntrenador() throws Exception {
        ...
        entrenador.setEdad(UPDATED_EDAD);
        ...
        assertThat(testEntrenador.getEdad()).isEqualTo(UPDATED_EDAD);
    }
