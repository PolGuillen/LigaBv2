...
import com.vasilmarkov.appjhipster.repository.SocioRepository;
...
public class SocioResourceTest {
    ...
    private static final String DEFAULT_ASIENTO = "SAMPLE_TEXT";
    private static final String UPDATED_ASIENTO = "UPDATED_TEXT";
    ...
    public void initTest() {
        ...
        socio.setAsiento(DEFAULT_ASIENTO);
    }
    ...
    public void createSocio() throws Exception {
        ...
        assertThat(testSocio.getAsiento()).isEqualTo(DEFAULT_ASIENTO);
    }
    ...
    public void checkAsientoIsRequired() throws Exception {
        ...
        List<Socio> socios = socioRepository.findAll();
        assertThat(socios).hasSize(databaseSizeBeforeTest);
    }
    ...
    public void getAllSocios() throws Exception {
        ...
        restSocioMockMvc.perform(get("/api/socios"))
                ...
                .andExpect(jsonPath("$.[*].asiento").value(hasItem(DEFAULT_ASIENTO.toString())));
    }
    ...
    public void getSocio() throws Exception {
        ...
        restSocioMockMvc.perform(get("/api/socios/{id}", socio.getId()))
            ...
            .andExpect(jsonPath("$.asiento").value(DEFAULT_ASIENTO.toString()));
    }
    ...
    public void updateSocio() throws Exception {
        ...
        socio.setAsiento(UPDATED_ASIENTO);
        ...
        assertThat(testSocio.getAsiento()).isEqualTo(UPDATED_ASIENTO);
    }
